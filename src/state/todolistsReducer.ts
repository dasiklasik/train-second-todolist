...
export const todolistsReducer = (state = initialState , action: todolistsActionType): Array<todolistType> => {
    switch (action.type) {
        ...
        case 'ADD-TODOLIST': {
            let newState = [...state]
            return [...newState, {id: action.payload.todolistId, title: action.payload.title, filter:'all'}]
        }
